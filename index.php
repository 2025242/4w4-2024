...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/normalize.scss">
    ...
    <div class="cartes-cours">
      ...
      if ($cours_query->have_posts()) {
        while ($cours_query->have_posts()) {
          ...
          // Supprime la durée du titre
          $titre_cours_sans_duree = str_replace("($duree_cours)", '', $titre_cours);
      
          // Affiche la carte du cours
          echo '<div class="carte-cours">';
          echo '<h5>' . esc_html($titre_cours_sans_duree) . '</h5>';
